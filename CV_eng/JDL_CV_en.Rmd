...
## \textbf{Recommendations} (\href{https://rr.peercommunityin.org/}{\textit{Peer Community In Registered Reports}})
...
\begin{small}
\textbf{Note:} For more information about my role as a \href{https://rr.peercommunityin.org/about/recommenders}{recommender} (equivalent to Associate Editor) for \textit{Peer Community In Registered Reports}, see the section dedicated to my \hyperref[editor]{editorial roles} below.
\end{small}
