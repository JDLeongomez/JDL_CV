...
\textbf{Leongómez, J. D.} (2023). \emph{ScolarlyOutput: Create and
Export a complete plot of your academic Google Scholar profile} (Version
1.0.0) {[}Computer software{]}.
\href{https://github.com/JDLeongomez/ScholarlyOutput}{https://doi.org/10.5281/zenodo.8060475}

\textbf{Leongómez, J. D.} (2021). \emph{ProbDnD: Probability of getting
a score in DnD, combining multiple dice and a modifier} {[}Computer
software{]}. \url{https://github.com/JDLeongomez/ProbDnD_EN}
