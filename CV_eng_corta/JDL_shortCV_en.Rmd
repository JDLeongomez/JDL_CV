...
\textbf{Open Science:} I am interested in quantitative methods and programming, especially in \textbf{R}, as tools to promote open and reproducible science. In line with these values, I serve as a \href{https://rr.peercommunityin.org/about/recommenders}{recommender} (associate editor) at \href{https://rr.peercommunityin.org/}{PCI Registered Reports}, and \textit{Data Editor} at \href{https://royalsocietypublishing.org/journal/rspb}{Proceedings of the Royal Society B}. 
\end{small}
\end{minipage} \begin{minipage}[c]{0.15\linewidth}
\begin{flushright} 
\hfill \href{https://jdleongomez.info/en/team/}{\includegraphics[width=2cm, height=2cm]{Logo_EvoCo.png}} \newline\newline \href{https://unbosque.portalinvestigacion.com/grupos/302}{\includegraphics[width=2cm, height=2cm]{Logo_CODEC.png}}
\end{flushright}
\end{minipage}
