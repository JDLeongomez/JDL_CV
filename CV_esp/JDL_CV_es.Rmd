...
\begin{flushright} 
\hfill \href{https://jdleongomez.info/es/team/}{\includegraphics[width=2cm]{Logo_EvoCo.png}} \newline\newline \href{https://grupo-codec.netlify.app/}{\includegraphics[width=2cm]{Logo_CODEC.png}}
\end{flushright}
\end{minipage}
