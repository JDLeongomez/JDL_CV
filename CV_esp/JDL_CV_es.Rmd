...
\begingroup
  ...
  `r knitr::knit_child("../bib/journal_es.txt")`
...
\begingroup
  ...
  `r knitr::knit_child("../bib/preprints.txt")`
...
## \textbf{Materiales de Curso Abierto}

\href{https://jdleongomez.github.io/curso-r/}{\textbf{Maneja, explora y visualiza datos con R}} es un curso introductorio gratuito que ofrecí en la \href{https://www.unbosque.edu.co/}{Universidad El Bosque} (Bogotá, Colombia) en junio de 2026. Todos los materiales del curso están disponibles abiertamente \href{https://jdleongomez.github.io/curso-r/}{en línea}.

## \textbf{Artículos de Divulgación Científica}
...
## \textbf{Aplicaciones Interactivas con Fines Educativos}
...
\begingroup
  ...
  `r knitr::knit_child("../bib/apps_es.txt")`
...
```{r service}
readxl::read_excel("../data/editorial_es.xlsx") |>
  tidyr::fill(-why) |>
  vitae::detailed_entries(what, when, with, where, why,
    .protect = FALSE
  )
