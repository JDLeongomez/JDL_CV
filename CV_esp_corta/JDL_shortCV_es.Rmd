...
Para una lista completa y descripción de responsabilidades, por favor consulta mi [sitio web](https://jdleongomez.info/es/#experience) o mi [Hoja de Vida Académica](https://jdleongomez.info/es/files/jdl_cv_es.pdf).
...
Para información sobre **subvenciones**, **becas** y **premios**, por favor visita mi [sitio web](https://jdleongomez.info/es/#accomplishments) o mi [Hoja de Vida Académica](https://jdleongomez.info/es/files/jdl_cv_es.pdf).
...
Para una lista completa, incluyendo la supervisión de pregrado, por favor visita mi [sitio web](https://jdleongomez.info/es/team/#students) o mi [Hoja de Vida Académica](https://jdleongomez.info/es/files/jdl_cv_es.pdf).
