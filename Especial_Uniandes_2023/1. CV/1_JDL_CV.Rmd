...
\blacktriangleright\blacktriangleright\blacktriangleright\space \textbf{Publicaciones en otros formatos}}
...
\end{minipage} \begin{minipage}[c]{0.90\linewidth} \begin{footnotesize}
He creado algunas aplicaciones con \href{https://shiny.posit.co/}{Shiny} en R, sobre todo con fines educativos. Aunque hay varias en desarrollo (aún privadas), en esta sección hay algunos ejemplos de aplicaciones públicas.
\end{footnotesize}
\end{minipage} 
