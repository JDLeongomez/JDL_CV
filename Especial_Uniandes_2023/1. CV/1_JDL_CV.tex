...
\begin{cventries}
    \cventry{Los valores corresponden a la puntuación media sobre 5.0}{Métodos cuantitativos II (Maestría en Psicología)}{Universidad El Bosque}{2017-2019}{\begin{cvitems}
\item Relevancia de los contenidos para el objetivo del programa: 4.75
\item Material aportado para apoyar el desarrollo del módulo: 4.67
\item Recursos didácticos utilizados: 4.64
\item Utilidad práctica de los contenidos: 4.63
\item Contribución de los contenidos a la vida profesional: 4,63
\item Cumplimiento del programa: 4.76
\item Diseño de las sesiones: 4.69
\item \textbf{ Media Aspectos Académicos y Metodológicos: 4.69}
\item Manejo conceptual claro y completo de los temas: 4.65
\item Claridad en sus exposiciones: 4.49
\item Terminología utilizada: 4.74
\item Uso de estrategias que desarrollan el pensamiento crítico-constructivo: 4,60
\item Uso de estrategias que facilitan la comprensión de conceptos: 4.61
\item Uso de estrategias que facilitan la aplicación de los conceptos abordados en la asignatura: 4.63
\item Disposición para resolver dudas: 4.71
\item Fomento de la participación en clase: 4.70
\item \textbf{ Media Condiciones Pedagógicas y Didácticas: 4.65}
\item Volumen de lecturas adecuado y objetivo: 4.70
\item Fomento del interés del alumno por aprender: 4,72
\item Retroalimentación de las actividades realizadas (talleres, seminarios, análisis de casos): 4.57
\item \textbf{Media Facilitadores del Aprendizaje: 4.71}
\end{cvitems}}
    \cventry{Los valores corresponden al porcentaje de alumnos que calificaron cada logro como alto \newline (las opciones eran bajo, medio, alto)}{Taller Proyecto de Grado I}{Universidad El Bosque}{2018}{\begin{cvitems}
...
\end{cvitems}}
    \cventry{Los valores corresponden al porcentaje de alumnos que calificaron cada logro como alto \newline (las opciones eran bajo, medio, alto)}{Fuentes y estilos de documentación en psicología}{Universidad El Bosque}{2015}{\begin{cvitems}
\item Ser capaz de leer sobre la temática de esta área de forma más crítica: 79.5\%
\item Corregir ideas y conceptos inexactos sobre este campo de la psicología: 70,5\%
\item Interés por la investigación sobre el área objeto de estudio: 77.3\%
\item Nuevos conceptos e investigaciones: 72.7\%
\item Aplicación de los conocimientos en el contexto psicológico: 81.8\%
\end{cvitems}}
\end{cventries}
