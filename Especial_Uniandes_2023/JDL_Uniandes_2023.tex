...
comportamiento humano desde una perspectiva transdisciplinar, así como
en los métodos cuantitativos aplicados a la ciencia abierta y
reproducible .}
...
\hypertarget{reponsabilidades}{%
\subsection{Reponsabilidades}\label{reponsabilidades}}
...
\subsection{Eventos Científicos}\label{eventos-cientuxedficos}}
...
\hypertarget{publicaciones-y-roles-editoriales}{%
\section{Publicaciones y Roles
Editoriales}\label{publicaciones-y-roles-editoriales}}

\hypertarget{roles-editoriales}{%
\subsection{Roles Editoriales}\label{roles-editoriales}}
...
\hypertarget{artuxedculos-y-trabajos-publicados}{%
\subsection{Artículos y Trabajos
Publicados}\label{artuxedculos-y-trabajos-publicados}}
...
\hypertarget{y-artuxedculos-en-revisiuxf3n}{%
\subsection{\texorpdfstring{\textit{Preprints} y Artículos en
Revisión}{ y Artículos en Revisión}}\label{y-artuxedculos-en-revisiuxf3n}}
...
\hypertarget{otras-publicaciones}{%
\subsection{Otras publicaciones}\label{otras-publicaciones}}
...
{[}Software{]}. \href{}{https://github.com/JDLeongomez/ProbDnD} (Versión
en español: \url{https://shiny.jdl-svr.lat/ProbDnD/}; Versión en inglés:
\url{https://shiny.jdl-svr.lat/ProbDnD_EN/})
